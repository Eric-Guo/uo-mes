<%@ Page Title="<%$ Resources:Caption %>" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="AssociateLot.aspx.cs" Inherits="UO_WebApplication.ShopFloor.AssociateLot" %>
...
<asp:Content ID="Holder1" ContentPlaceHolderID="Holder1" runat="server">
    ...
    <asp:ObjectDataSource ID="ODS_Details" runat="server" 
        TypeName="UO_Service.ContainerTxn.Associate" SelectMethod="SelectDetails" 
        DataObjectTypeName="UO_Service.ContainerTxn.AssociateDetail"
...
<td><asp:Button ID="btnAssociate" runat="server" Text="<%$ Resources:Execute %>" onclick="btnAssociate_Click"/></td>
        </tr>
        <tr>
