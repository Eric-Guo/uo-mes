<%@ Page Title="<%$ Resources:Caption %>" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="Thruput.aspx.cs" Inherits="UO_WebApplication.ShopFloor.Thruput" %>
...
<asp:Content ID="Footer1" ContentPlaceHolderID="Footer1" runat="server">
    <table>
        <tr>
            <td>
    <asp:Button ID="btnThruput" runat="server" Text="<%$ Resources:Execute %>" onclick="btnThruput_Click"/>
            </td>
        </tr>
        <tr>
